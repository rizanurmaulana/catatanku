      ...
      <div class="card mb-4">
        <div class="card-header pb-0 p-3">
          <div class="row">
            <div class="d-flex align-items-center">
              <h6 class="mb-0">Tambahkan Pembayaran</h6>
            </div>
          </div>
        </div>
        <div class="card-body pt-3 pb-2">
          <div class="row">
            <div class="col-12">
              <div class="row">
                <form action="/customers/<?= $customer['id']; ?>/payment" method="post">
                  <?= csrf_field() ?>
                  <div class="form-group">
                    <label for="id_pelanggan" class="form-control-label">Pelanggan</label>
                    <input type="text" class="form-control" value="<?= $customer['name']; ?>" required readonly>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="rupiah" step="0.01" class="form-control" name="total_amount" required>
                  </div>
                  <div class="form-group">
